    ...
    return (
      <div className="px-5 py-6 text-white"
        ...
        <div className="flex items-center gap-4">
          <div className="w-[60px] h-[60px] rounded-full bg-white/20 flex items-center justify-center text-3xl">👤</div>
          <div>
            <h2 className="text-lg font-bold">请登录</h2>
            <span className="inline-block mt-0.5 px-2 py-0.5 rounded-full bg-white/20 text-xs">游客</span>
          </div>
        </div>
      </div>
    )
